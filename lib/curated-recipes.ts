...
function overrideCuratedRecipeContent(recipe: CuratedRecipe): CuratedRecipe {
  if (recipe.name === "간장계란밥" || recipe.name === "계란간장밥") {
    return {
      ...
      storageTip: "계란 프라이가 들어간 밥은 바로 먹는 편이 가장 좋습니다.",
      reheatTip: "남겼다면 냉장 보관 후 물 1큰술을 넣고 전자레인지에 1분 데웁니다.",
  ...
  if (recipe.name === "두부조림") {
    return {
      ...
      ingredientDetails: [
        ingredient("두부", "1모", "단단한 두부가 조릴 때 덜 부서집니다."),
        ingredient("식용유", "1큰술", "두부 겉면을 먼저 잡아줍니다."),
        ingredient("간장", "2큰술", "조림 양념의 기준입니다."),
        ingredient("물", "1/2컵", "양념이 타지 않게 합니다."),
        ingredient("설탕", "1작은술", "간장의 짠맛을 부드럽게 합니다."),
        ingredient("대파", "2큰술", "마지막 향을 더합니다."),
      ],
      steps: [
        { index: 1, title: "두부 자르고 닦기", description: "두부 1모를 손가락 두께로 자르고 키친타월로 겉물기를 닦습니다.", imageUrl: "/images/recipes/beginner-recipe-guides/prep/beginner-028.png", imageAlt: "두부조림 두부 자르기", heat: "불 없음", minutes: 3, beginnerTip: "너무 얇게 자르면 조릴 때 쉽게 부서집니다.", visualCue: "두부 표면이 축축하지만 물이 흐르지 않으면 됩니다.", commonMistake: "물기가 많으면 팬에서 튀고 양념이 묽어집니다.", rescueTip: "물기가 많으면 키친타월을 새로 깔고 1분 더 두세요." },
        { index: 2, title: "두부 먼저 부치기", description: "팬에 식용유 1큰술을 두르고 두부를 중불에서 앞뒤로 2분씩 부칩니다.", imageUrl: "/images/recipes/beginner-recipe-guides/steps/beginner-028.png", imageAlt: "두부조림 두부 부치기", heat: "중불", minutes: 4, beginnerTip: "먼저 살짝 부쳐야 양념을 넣어도 덜 부서집니다.", visualCue: "두부 겉면이 살짝 노란색으로 단단해지면 됩니다.", commonMistake: "부치지 않고 바로 조리면 두부가 쉽게 부서집니다.", rescueTip: "부서진 두부는 건드리지 말고 양념을 끼얹어 마무리하세요." },
        { index: 3, title: "양념 넣기", description: "간장 2큰술, 물 1/2컵, 설탕 1작은술을 섞어 팬에 붓습니다.", imageUrl: "/images/recipes/beginner-recipe-guides/steps/beginner-028.png", imageAlt: "두부조림 양념 넣기", heat: "중약불", minutes: 2, beginnerTip: "물 1/2컵이 있어야 간장이 타지 않고 두부에 배어듭니다.", visualCue: "양념이 두부 가장자리에서 보글보글 끓으면 됩니다.", commonMistake: "물을 빼면 간장이 빨리 타고 짜집니다.", rescueTip: "양념이 빨리 졸면 물 2큰술을 더 넣으세요." },
        { index: 4, title: "끼얹어 조리기", description: "대파를 넣고 숟가락으로 양념을 두부 위에 3~4번 끼얹은 뒤 불을 끕니다.", imageUrl: "/images/recipes/beginner-recipe-guides/beginner-028.png", imageAlt: "완성된 두부조림", heat: "중약불", minutes: 3, beginnerTip: "뒤집기보다 양념을 끼얹는 편이 두부가 덜 부서집니다.", visualCue: "팬 바닥에 양념이 조금 남고 두부에 갈색 윤기가 돌면 완성입니다.", commonMistake: "오래 뒤적이면 두부가 부서집니다.", rescueTip: "뒤집지 말고 숟가락으로 양념만 끼얹으세요." },
      ],
      source: JIPBAB_ORIGINAL_SOURCE,
      safety: JIPBAB_ORIGINAL_SAFETY,
    };
  ...
  if (recipe.name === "두부조림") {
    return {
      ...
      ingredientDetails: [
        ingredient("두부", "1모", "부침용 두부가 가장 쉽습니다.", "키친타월로 물기를 닦습니다."),
        ingredient("간장", "2큰술", "조림 양념의 기준입니다.", "처음부터 더 넣지 않습니다."),
        ingredient("물", "1/2컵", "양념이 타지 않게 합니다.", "종이컵 반 컵입니다."),
      ...
      requiredTools: ["프라이팬", "뒤집개", "그릇"],
      beginnerSummary: "두부를 먼저 부친 뒤 간장 2큰술과 물 1/2컵을 넣고 짧게 조리면 부서짐이 적습니다.",
      steps: [
        {
          index: 1,
          title: "두부 물기 닦기",
          description: "두부를 손가락 두께로 자르고 키친타월로 겉물을 닦습니다.",
          imageUrl: null,
          imageAlt: "두부조림 두부 준비 단계",
          heat: "불 없음",
          minutes: 3,
          beginnerTip: "물기가 많으면 기름이 튀고 두부가 잘 부서집니다.",
          visualCue: "두부 표면에 물방울이 거의 없으면 됩니다.",
          commonMistake: "두부를 너무 얇게 자르면 뒤집을 때 찢어집니다.",
          rescueTip: "부서진 두부는 그대로 밥 위에 올려 먹어도 됩니다.",
        },
        {
          index: 2,
          title: "두부 부치기",
          description: "팬에 식용유 1큰술을 두르고 두부를 중불에서 앞뒤로 2분씩 부칩니다.",
          imageUrl: null,
          ...
          rescueTip: "붙었으면 불을 약하게 낮추고 20초 기다린 뒤 떼세요.",
        },
        {
          index: 3,
          title: "양념 넣기",
          description: "간장 2큰술, 물 1/2컵, 설탕 1작은술을 섞어 팬에 붓습니다.",
          imageUrl: null,
          imageAlt: "두부조림 양념 넣는 단계",
          heat: "중약불",
          minutes: 3,
          beginnerTip: "물이 있어야 간장이 바로 타지 않습니다.",
          visualCue: "양념이 두부 옆에서 보글보글 끓으면 됩니다.",
        ...
        },
        {
          index: 4,
          title: "마무리 조리기",
          description: "대파를 넣고 양념을 두부 위에 끼얹으며 2분 더 조립니다.",
          imageUrl: null,
          imageAlt: "완성된 두부조림",
          heat: "약불",
          minutes: 2,
          ...
          commonMistake: "국물이 완전히 없어질 때까지 조리면 짜집니다.",
          rescueTip: "너무 졸았다면 물 2큰술을 넣고 불을 바로 끄세요.",
        },
      ],
      successCheck: "두부가 따뜻하고 양념이 겉면에 묻어 있으며 팬 바닥에 양념이 조금 남으면 성공입니다.",
      noFire: false,
      microwave: false,
    };
  }
