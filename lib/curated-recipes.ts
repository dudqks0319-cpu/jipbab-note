  ...
  if (recipe.name === "버터간장계란밥") {
    return {
      ...
      ingredientDetails: [
        ...
        ingredient("참기름", "1작은술", "버터 향이 강하면 생략해도 됩니다.", "마지막에 넣습니다.", false),
      ...
      steps: [
        ...
        {
          index: 3,
          description: "계란을 올리고 간장 1큰술과 참깨를 넣습니다. 참기름 1작은술은 원하면 마지막에 넣습니다.",
  ...
  if (recipe.name === "김치볶음밥") {
    return {
      ...
      ingredientDetails: [
        ...
        ingredient("대파", "2큰술", "없어도 되지만 넣으면 볶음밥 향이 좋아집니다.", undefined, false),
        ingredient("계란", "1개", "프라이로 올리면 짠맛을 부드럽게 잡아줍니다."),
        ingredient("식용유", "1큰술", "김치를 먼저 볶을 때 팬에 둘러줍니다."),
        ingredient("간장", "1작은술", "김치가 짜면 생략하세요.", undefined, false),
  ...
  if (recipe.name === "스팸마요덮밥") {
    return {
      ...
      ingredientDetails: [
        ...
        ingredient("간장", "1작은술", "스팸이 짜면 생략해도 됩니다.", undefined, false),
        ingredient("김가루", "1큰술", "마지막에 올리면 한 그릇 느낌이 납니다."),
      ],
      steps: [
        ...
        { index: 4, title: "마요 올리기", description: "밥 위에 스팸과 계란을 올리고 마요네즈 1큰술과 김가루를 뿌립니다. 맛을 본 뒤 싱거울 때만 간장을 1/2작은술씩 더합니다.", imageUrl: "/images/recipes/beginner-recipe-guides/beginner-021.png", imageAlt: "완성된 스팸마요덮밥", heat: "불 없음", minutes: 1, beginnerTip: "스팸이 짠 편이면 간장은 넣지 않아도 됩니다.", visualCue: "밥 위에 스팸, 계란, 마요네즈가 따로 보이면 비비기 좋습니다.", commonMistake: "스팸이 짠데 간장을 많이 넣으면 전체가 짭니다.", rescueTip: "짜면 밥을 반 공기 더 넣거나 마요네즈를 조금 더해 부드럽게 잡으세요." },
      ],
      source: JIPBAB_ORIGINAL_SOURCE,
      safety: JIPBAB_ORIGINAL_SAFETY,
    };
  ...
  if (recipe.name === "두부조림") {
    return {
      ...
      ingredientDetails: [
        ...
        ingredient("설탕", "1작은술", "짠맛을 부드럽게 합니다.", "생략 가능하지만 넣으면 초보자가 먹기 쉽습니다.", false),
        ingredient("대파", "2큰술", "향을 더합니다.", "없으면 생략 가능합니다.", false),
      ...
      beforeStart: [
        ...
        "두부를 키친타월 위에 5분 두어 물기를 빼고 간장 2큰술과 물 100ml를 섞습니다. 단맛을 원하면 설탕 1작은술도 섞습니다.",
      ...
      steps: [
        ...
        },
        {
          index: 3,
          title: "양념 넣기",
          description: "간장 2큰술과 물 100ml를 섞어 팬에 붓고 중약불로 낮춥니다. 단맛을 원하면 설탕 1작은술도 함께 섞습니다.",
          imageUrl: null,
        ...
        },
        {
          index: 4,
          title: "5~7분 조리기",
          description: "대파가 있으면 넣고, 중약불에서 5~7분 동안 양념을 3~4번 끼얹으며 조립니다.",
          imageUrl: null,
          imageAlt: "완성된 두부조림",
          heat: "약불",
          minutes: 6,
