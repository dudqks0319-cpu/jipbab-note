...
const checks = [
  ...
  {
    label: "iOS release artifact gate",
  ...
  {
    label: "App Store external status",
    args: ["scripts/check-appstore-external-status.mjs"],
  },
];
...
console.log("App Store submission readiness gate");
console.log("This command does not submit to App Store Connect.");
console.log("This command does not validate Google Play production or internal testing readiness.");
...
if (blocked.length > 0) {
  console.log("\nApp Store submission is blocked. Do not submit this build to App Store review.");
  console.log("Resolve every blocked App Store gate above, then rerun `pnpm release:appstore-submit-gate`.");
  process.exit(1);
}

console.log("\nApp Store submission gate passed.");
console.log("Proceed with App Store review submission only after confirming the target app record and release version in App Store Connect.");
