...
| production hotfix code | `agent/sync-ux-release`의 `0f09d3310a7af34566c555777c7798a99534c330` | 현재 운영 런타임 기준 코드 |
...
| 현재 production deployment | `dpl_4E3vgwatsqtU8TaFPubd6swmhhu8` | `READY`, `0f09d33` 레시피 미리보기 20개 hotfix |
...
| 원격 migration history | publication `20260710130000`, Phase 1 schema `20260710150000`, Phase 2 rate limit `20260710160000`, app helper hardening `20260715120555`, 재료 분류 교정 `20260715121937`까지 기록 | 적용 migration은 실제 live schema와 일치, 그 이전 로컬 누락 이력과 Phase 1 catalog seed는 별도 정리 필요 |

현재 production 런타임은 canonical 저장소의 `0f09d3310a7af34566c555777c7798a99534c330` 제한 웹 hotfix와 일치한다. 다만 Vercel 프로젝트의 Git 연결은 여전히 오래된 private 저장소 `jipbab-note-app/main`이므로 다음 일반 배포는 Git integration만으로 재현할 수 없고 P0 source mismatch가 남는다.
...
2026-07-15 웹 hotfix에서는 운영 도메인과 Vercel 프로젝트를 유지한 채 `0f09d3310a7af34566c555777c7798a99534c330` 산출물을 배포했다. GitHub default branch 이동과 Vercel Git relink는 수행하지 않았으며 다음 비-hotfix production 배포 전 해결해야 한다.
