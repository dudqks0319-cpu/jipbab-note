...
앱에서는 `/recipe/infant-toddler`에서 이름, 조사된 정량, 조리 흐름 요약, 알레르기, 출처 분류와 권리 상태를 볼 수 있습니다. 이 후보들은 추천 API, 일반 레시피 목록, 조리 모드와 publication evidence에 포함되지 않습니다.
...
- 후보 데이터: `lib/infant-toddler-recipes.ts`
- 사용자 화면: `app/recipe/infant-toddler/page.tsx`
